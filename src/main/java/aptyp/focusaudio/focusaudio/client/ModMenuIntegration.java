...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            general.addEntry(eb.startBooleanToggle(Text.literal("Enabled"), FocusConfig.instance.enabled)
                    .setDefaultValue(true)
                    .setSaveConsumer(v -> FocusConfig.instance.enabled = v)
                    .build());
            ...
            general.addEntry(eb.startFloatField(Text.literal("Lerp Speed (0.01 - 1.0)"), FocusConfig.instance.lerpSpeed)
                    .setDefaultValue(0.1f)
                    .setSaveConsumer(v -> FocusConfig.instance.lerpSpeed = v)
                    .build());
